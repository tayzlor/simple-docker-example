...
http.createServer(function(req, res) {
  ...
  res.write(
    ...
    '<style type="text/css">body {background: #2196F3;width: 35em;margin: 0 auto;font-family: Tahoma, Verdana, Arial, sans-serif;}</style>\n' +
    '\n\n<h1>Hello!</h1>\n' +
    '<div id="content">\n' +
    '<p>Application version <strong>2.0.0</strong></p>' +
